...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_5x6(
     ...
     KC_LALT, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_EQL,
                      KC_LBRC,KC_RBRC,                                                       KC_LBRC, KC_RBRC,
                                      KC_ENT,KC_SPC,                        KC_LBRC, KC_RBRC,
                                      KC_LGUI, KC_HOME,                     KC_END,  KC_LSFT,
                                      KC_LSFT, LOWER,                       RAISE, KC_LALT
  ),
  ...
  [_RAISE] = LAYOUT_5x6(
       ...
       KC_MUTE,_______,KC_END ,KC_UP  ,KC_END ,KC_PGUP,                        _______,_______,_______,_______,_______,KC_F12 ,
